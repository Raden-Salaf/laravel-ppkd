...
@section('title', 'Super Key Management')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="mb-3" align="right">
                <a href="{{ route('key.create') }}" class="btn btn-primary">Create New key$key</a>
            </div>
                ...
                <tbody>
                    @foreach ($keys as $index => $key)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('key.edit', $key->id) }}" class="btn icon btn-success btn-sm ">
